...
5. Image screenshots of the main page created in high fidelity (saved to disk in the project)
...
- A report should be generated that measures all of the items outlined above
