...
- Box, Flex, Grid, Text, Heading, Card, and Divider come from Sanity UI "@sanity-labs/ui-poc", NOT from Sanity UI "@sanity/ui".
- You MUST add "@sanity-labs/ui-poc@0.0.1-alpha.11" to package.json dependencies.
- You MUST import "@sanity-labs/ui-pocstyles.css" in main.tsx.
